            ...
            <div class="card-body">      
                <div class="">
                    <div class="row justify-content-center align-items-center mb-1">
                        <template v-for="formule in formules">
                            <div class="col-md-3" v-if="formule.online==1">
                                <div class="card card-pricing card-pricing-focus card-primary">
                                    <div class="card-header">
                                        <h4 class="card-title">{{formule.title}}</h4>
                                        <div class="card-price">
                                            <span class="price">{{formule.price}} Dt</span>
                                    ...
                                    <div class="card-footer">
                                        <button class="btn btn-light btn-block"><b>Commencer</b></button>
                                    </div>
                                </div>
                            </div>
                        </template>
    ...
    export default {
        ...
        methods: {
            ...
            getFormule: function(Formule){
                let res = fetch(window.location.origin + '/api/formules',{
                    headers : {
