    ...
    data(){
        return {
            ...
            currentQuestion : {
                ...
                label : 'Icons',
                textquestion : '',
                questions:[ {id : 1, text : 'Bad', icon : 'fas fa-star', color : '#efef44', statcolor : 'red'}, 
                            {id : 2, text : 'Normal', icon : 'fas fa-star', color : '#efef44', statcolor : 'orange'},
                            {id : 3, text : 'Good', icon : 'fas fa-star', color : '#efef44', statcolor : 'green'}],
                question_type : "icons", 
                order: 1, 
