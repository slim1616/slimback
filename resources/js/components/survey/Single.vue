        ...
        changeTypeQuestion(){
            if (this.selectedTypeQuestion=='icons'){
                this.currentQuestion = {
                    ...
                    textquestion : '',
                    obligatoire : true,
                    questions:[ {id : 1, text : 'Bad', mobicon : 'star', icon : 'fas fa-star', color : 'red', statcolor : 'red'}, 
                                {id : 2, text : 'Normal', mobicon : 'star', icon : 'fas fa-star', color : 'orange', statcolor : 'orange'},
                                {id : 3, text : 'Good', mobicon : 'star', icon : 'fas fa-star', color : 'green', statcolor : 'green'}],
                    question_type : "icons", 
                    order: 1, 
                    'icon' : 'fa-check-square', 
                    status: "offline"
